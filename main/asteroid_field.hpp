...
class AsteroidField
{
	...
	public:
		...
		std::size_t hit_test_and_destroy( Vec2f const& aPos, float aRadius );
		bool collides( Vec2f const& aPos, float aRadius ) const;
	...
	private:
		...
		void respawn_asteroid_( std::size_t aIndex );
		void spawn_split_asteroid_( Vec2f const& aPos, Vec2f const& aVelocity );
