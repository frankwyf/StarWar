...
namespace
{
	constexpr char const* kWindowTitle = "Starblaster: Triangle Sandbox";
...
#				endif
		...
		switch( testId )
		{
			...
			// Additional experimental cases
			// testing fully offscreen cases
			case 4: {
				// testing window size
				...
				draw_triangle_solid(surface,
					{ -21.f, 29.f }, { -221.f, 129.f }, { -21.f, 500.f },
					{ 100, 100, 100 }
				);
				// Fully of right 
				draw_triangle_solid(surface,
					{ 700.f, 29.f }, { 900.f, 129.f }, { 900.f, 500.f },
					{ 100, 100, 100 }
				);
				// Fully off up
				draw_triangle_solid(surface,
					{ 21.f, 590.f }, { 221.f, 990.f }, { 800.f, 500.f },
					{ 100, 100, 100 }
				);
				// Fully off below
				draw_triangle_solid(surface,
					{ 21.f, -290.f }, { 221.f, -1290.f }, { 2100.f, -500.f },
					{ 100, 100, 100 }
				);
			}break;
			// testing the overlapping cases
			case 5: {
				// testing window size
				draw_rectangle_outline(surface,
					{ 0.f, 0.f }, { 640.f, 480.f },
