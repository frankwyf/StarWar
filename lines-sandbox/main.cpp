...
namespace
{
	constexpr char const* kWindowTitle = "Starblaster: Line Sandbox";
...
#				endif
		...
		switch( testId )
		{
			...
			// new test case NO.1: two lines that are crossed over (overlapping)
			case 5: { 
				// testing window size
